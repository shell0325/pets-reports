/*
  ...
  - You are about to alter the column `gender` on the `pets` table. The data in that column could be lost. The data in that column will be cast from `VarChar(10)` to `Enum(EnumId(2))`.
...
-- AlterTable
ALTER TABLE `pets` MODIFY `gender` ENUM('MEN', 'WOMEN', 'OTHERS') NOT NULL,
